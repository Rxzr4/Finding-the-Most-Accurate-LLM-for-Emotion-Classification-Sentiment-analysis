...
def main():
    ...
    try:
        ...
        print("   ✓ Groq API (LLaMA 3.1 8B) connected")
    except Exception as e:
        print(f"   ✗ LLaMA 3.1 8B failed: {e}")
    
    try:
        call_groq("Say OK", "llama-3.3-70b-versatile", GROQ_API_KEY, max_tokens=5)
        print("   ✓ Groq API (LLaMA 3.3 70B) connected")
    except Exception as e:
    ...
    try:
        ...
        print("   ✓ OpenRouter API (Trinity Large) connected")
    except Exception as e:
        print(f"   ✗ Trinity Large failed: {e}")
